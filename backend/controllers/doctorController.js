...
const loginDoctor = async (req, res) => {
    try {
        ...
        if(!doctor){
            return res.json({success: false, message: "Doctor not found bro"})
        }
        ...
        if (isMatch) {
            ...
            return res.json({success: false, message: "Doctor not found yko"})
        }
    } catch (error) {
        console.log(error);
        res.json({ success: false, message: error.message });
...
//API for appointment cancellation for doctor panel

    ...
    <div className="max-w-lg flex flex-col gap-2 text-sm">
      ...
      {isEdit ? (
        ...
        <div className="mt-10">
          {
            isEdit
            ? <button className="border bg-gray-100 text-gray-800 px-8 py-2 rounded-full hover:bg-blue-600 hover:text-white transition-all duration-300" onClick={() => setIsEdit(false)}>Save Information</button>
